...
allowed[msg.sender][_spender] = allowed[msg.sender][_spender]+(_addedValue);//Mutation Here for<185>
...
contract PKT is StandardToken {
  ...
  function mint(address _holder, uint256 _value) external icoOnly {
    ...
    require(_value != 0);
	require(totalSupply + _value>_value);  //<repair>
    require(totalSupply + _value <= tokenLimit);  //<overflow>

	require(balances[_holder] + _value>_value);  //<repair>
