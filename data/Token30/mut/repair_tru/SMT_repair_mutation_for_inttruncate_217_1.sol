...
contract SMT is StandardToken {
    ...
    function transferProxy(address _from, address _to, uint256 _value, uint256 _feeSmt,
		...
		if(_feeSmt + _value < _value) revert();  //<repair>
        if(balances[_from] < _feeSmt + _value) revert();  //<overflow>
...
|| balances[msg.sender] +uint128(_feeSmt) < balances[msg.sender]) revert();//Mutation Here for <217>
        balances[_to] += _value;
        Transfer(_from, _to, _value);
